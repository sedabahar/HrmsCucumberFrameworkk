...
public class CommonMethods extends BaseClass {
    ...
    public static byte[] takeScreenshot(String fileName) {
    	...
    	Date date =new Date();
    	SimpleDateFormat sdf=new SimpleDateFormat ("yyyy_MMdd_HHmms");
    ...
    /**
     * This method will be click on the element
     * @param element
     */
    ...
    public static WebDriverWait getWaitObject() {
        WebDriverWait wait = new WebDriverWait(driver, Constants.IMPLICIT_LOAD_TIME);
        return wait;
    }
    /**
    ...
    public static void selectbySelected(WebElement element,String text) {
    ...
    if(!isFound) {
		System.out.println("Value"+index+" was not selected");
	}
    }
    /**
     * 
